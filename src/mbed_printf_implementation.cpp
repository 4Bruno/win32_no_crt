...
/*
 * Modifications:
 *  - Added cast to int to avoid truncation warning
 *  - Removed dependency to fputc to serial output only buffer
 */
...
{
    /* get integer part */
    MBED_SIGNED_STORAGE integer = (MBED_SIGNED_STORAGE)value;
    ...
    if (dec_precision != 0) {
        ...
        MBED_UNSIGNED_STORAGE decimal = (MBED_UNSIGNED_STORAGE)value;
        ...
        for (size_t index = 0; format[index] != '\0'; index++) {
            ...
            if (format[index] == '%') {
                ...
                if ((format[next_index] == '.') &&
                    ...
                    precision = (int)va_arg(arguments, MBED_SIGNED_NATIVE_TYPE);
                ...
                /* character */
                    ...
                    char value = (char)va_arg(arguments, MBED_SIGNED_NATIVE_TYPE);
                    index = next_index;
